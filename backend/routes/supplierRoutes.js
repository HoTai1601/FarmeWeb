...
router.route("/all").get(getMyProductsForPublic);

router.route("/myproducts").get(protect, getMyProducts);

router.route("/product/:id").get(protect, getFarmerProductById);

router.route("/product/:id/edit").put(protect, updateSupplierProductProfile);
