...
export const supplierProductListReducer = (
  state = { products: [] },
  action
) => {
  switch (action.type) {
...
export const supplierProdictListMyReducer = (
  state = { products: [] },
  action
) => {
  switch (action.type) {
...
export const FarmerProductDetailsReducer = (
  state = { product: {} },
  action
) => {
  switch (action.type) {
...
export const farmerProductUpdateReducer = (
...
// For all
export const supplierProductForAllListReducer = (
  state = { products: [] },
  action
) => {
  switch (action.type) {
